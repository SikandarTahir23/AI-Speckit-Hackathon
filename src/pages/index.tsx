            ...
            <div className="row">
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__footer">
                    <Link to="/docs/chapter-1-introduction-to-physical-ai">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__footer">
                    <Link to="/docs/chapter-2-basics-of-humanoid-robotics">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__body">
                    <p><strong>AI and Control Systems for Humanoids</strong></p>
                    <p>Master the industry-standard framework for robot software development.</p>
                  </div>
                  <div className="card__footer">
                    <Link to="/docs/chapter-3-ai-control-systems">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__footer">
                    <Link to="/docs/chapter-4-digital-twin-simulation">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__footer">
                    <Link to="/docs/chapter-5-ros2-fundamentals">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__footer">
                    <Link to="/docs/chapter-6-simple-ai-robot-pipeline">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__body">
                    <p><strong>Vision-Language-Action (VLA) Systems</strong></p>
                    <p>Integrate all concepts to build a complete AI-robot pipeline.</p>
                  </div>
                  <div className="card__footer">
                    <Link to="/docs/chapter-7-vision-language-action-systems">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
              ...
              <div className="col col--4">
                <div className="card margin-bottom--lg">
                  ...
                  <div className="card__body">
                    <p><strong>Ethical and Future Implications</strong></p>
                    <p>Integrate all concepts to build a complete AI-robot pipeline.</p>
                  </div>
                  <div className="card__footer">
                    <Link to="/docs/chapter-8-ethical-future">
                      Read Chapter →
                    </Link>
                  </div>
                </div>
